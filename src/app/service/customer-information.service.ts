...
export class CustomerInformationService {
  ...
  private behaviorSubject: BehaviorSubject<CustomerInformation> = new BehaviorSubject<CustomerInformation>(new CustomerInformation());
  private customerInformationObservable: Observable<CustomerInformation> = this.behaviorSubject.asObservable();
